...
/* ---------------- Routes ---------------- */
app.get("/api/health",(req,res)=>res.json({ok:true,version:"7.7.3-bilingual",timezone:APP_TIME_ZONE,mode:MODE,providers:{apiFootball:!!API_KEY,footballData:true,fixtureFallback:true},features:{yesterdayTodayTomorrow:true,timezoneNormalization:true,fixtureMerge:true,analysisToggle:true}}));
...
</style></head><body><div class="app"><div class="top"><div class="brand">MatchEdge <span class="gold">Premium</span></div><div style="display:flex;gap:10px;align-items:center"><div class="live">● LIVE DATA</div><div class="langSwitch"><button class="langBtn active" id="trBtn" onclick="setLang('tr')" aria-label="Türkçe">🇹🇷</button><button class="langBtn" id="enBtn" onclick="setLang('en')" aria-label="English">🇬🇧</button></div></div></div><div class="hero"><div class="days" id="days"></div></div><div class="leagues" id="leagues"></div><div class="summary"><div class="stat"><strong id="mc">—</strong><span id="sumMatches">SEÇİLİ GÜN MAÇI</span></div><div class="stat"><strong id="ac">0</strong><span id="sumAnalysis">AÇIK ANALİZ</span></div><div class="stat"><strong id="threeDayStrong">3 GÜN</strong><span id="sumDays">DÜN · BUGÜN · YARIN</span></div></div><details class="dailyPicks" id="dailyPicks" ontoggle="if(this.open)loadDailyPicks()"><summary id="dailyPicksTitle">GÜNÜN SEÇİMLERİ · RİSK BAZLI</summary><div class="dailyPicksBody" id="dailyPicksBody"><div class="loader">Hazır olduğunda yüklenir.</div></div></details><div class="head"><h2 id="dayHeading">Maçlar</h2><span id="fc"></span></div><div id="fixtures"><div class="loader">Fikstür yükleniyor…</div></div><div class="footerNote" id="footerNote"></div></div><script>
...
app.listen(PORT,"0.0.0.0",()=>console.log(`MatchEdge Premium V7.7.3 running on port ${PORT}`));
